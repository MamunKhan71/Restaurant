...
const Header = () => {
    return (
        <div className="h-full w-full bg-[url('header-bg.png')] overflow-hidden bg-cover pt-24">
            <div className='container mx-auto py-8 text-white h-screen relative'>
                <div className='flex items-center mt-96'>
                    ...
                    <div className='absolute right-0'>
                        <img className=' z-10 w-[700px] h-[649px] object-cover right-0' src="header-img.jpeg" alt="header-image" />
                        <div className='absolute bottom-0 shadow-2xl flex items-center justify-center z-20 -right-16 bg-primary h-32 w-32 rounded-full'>
                    ...
                    <div className='absolute top-[55px] -right-[28px] z-30'>
