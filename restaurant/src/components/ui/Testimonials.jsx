        ...
        <div className='relative overflow-hidden'>
            <div className='container mx-auto space-y-16'>
                ...
                <div className='grid grid-cols-6'>
                    <div className='bg-[#FEBF00] p-16 relative basis-[42.15%] h-full w-full col-span-2 flex flex-col justify-between'>
                        <span className='text-2xl font-bold absolute top-12 left-10'>
                            <img src="quotes.svg" alt="quotes" />
                        </span>
                        <p className='max-w-96 font-secondary text-[#0A1425] leading-9 text-xl'>You can't go wrong with Chicken Mandi, I had it twice. The chicken was cooked perfectly, juicy & soft (usually mandi chicken is a bit dry). I would defiantly recommend it.</p>
                        <div className='flex flex-col justify-between '>
                            <div className='flex items-center justify-between'>
                                <div>
                                    <p className='text-[#0A1425] font-bold font-bebas text-lg'>Khalid Al Dawsry</p>
                                    <p className='text-[#333] font-secondary text-sm'>Jeddah, Saudi</p>
                                </div>
                                <div className='rounded-full space-y-4 flex flex-col'>
                                    <img className='rounded-full size-10 object-cover' src="profile.png" alt="profile-pic" />
                                    <hr className='border-[#BD1F17] border-2 max-w-10' />
                                </div>
                            </div>
                            <hr className='border border-[#BD1F17]' />
                        </div>
