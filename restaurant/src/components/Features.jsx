            ...
            <div className='flex flex-col md:flex-row gap-8 md:gap-20 items-start justify-between w-full container mx-auto'>
                ...
                <div className='flex-1'>
                    <Tabs>
                        ...
                        <TabPanel>
                            <div className='mt-8 space-y-5'>
                                <h1 className='font-bebas font-bold text-6xl leading-[62px] tracking-wider'>
                                    A Journey Through Culinary Arts
                                </h1>
                                <p className='text-normal text-base font-normal font-secondary leading-7'>
                                    Immerse yourself in an exceptional culinary adventure, where flavors come alive and dining becomes an experience. With an emphasis on authenticity and quality, each dish tells a story, crafted with the finest ingredients and a touch of culinary artistry. Whether it's the aroma of freshly prepared spices or the harmony of unique flavors, we invite you to explore the world through our dishes.
                                </p>
                                <div className='flex gap-8 items-center'>
                                    ...
                                    <div className='flex gap-2 items-center'>
                                        ...
                                        <p className='font-semibold font-secondary'>Call Us</p>
                                    </div>
                                </div>
                            </div>
                        </TabPanel>
                        ...
                        <TabPanel>
                            <div className='mt-8 space-y-5'>
                                ...
                                <div className='space-y-2'>
                                    <p className='font-bold text-[#0A1425]'>Email: mkmamun031@gmail.com</p>
                                    <p className='font-bold text-[#0A1425]'>Phone: 01643091606</p>
                                    <p className='font-bold text-[#0A1425]'>
                                        Portfolio:
                                        <a href="http://mdmamun.tech" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline ml-2">
                                            mdmamun.tech
                                        </a>
                                    </p>
                                    <p className='font-bold text-[#0A1425]'>
                                        GitHub:
                                        <a href="https://github.com/MamunKhan71" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline ml-2">
                                            MamunKhan71
                                        </a>
                                    </p>
                                    <p className='font-bold text-[#0A1425]'>
                                        LinkedIn:
                                        <a href="https://www.linkedin.com/in/mdmamun99/" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline ml-2">
                                            mdmamun99
                                        </a>
                                    </p>
                                </div>
